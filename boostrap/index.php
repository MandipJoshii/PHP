  ...
  <body>
    ...
    <section class="bg-dark py-5">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <h1 class="text-light fs-3">Logo</h1>
          </div>
          <div class="col-md-4">
            <a class="text-light fs-2 text-decoration-none " href="#">link1</a>
            <a class="text-light fs-2 text-decoration-none ms-2 me-2" href="#">link3</a>
            <a class="text-light fs-2 text-decoration-none" href="#">link2</a>
          </div>
          <div class="col-md-4 ">
